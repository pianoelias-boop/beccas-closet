...
CAT_RULES=[('Jumpsuits & Rompers',r'jumpsuit|romper|playsuit|overall|coverall|boilersuit|dungaree'),('Dresses',r'\bdress|gown|kaftan|caftan'),('Skirts',r'\bskirt'),('Jeans',r'\bjean|denim (pant|trouser)'),('Pants',r'\bpant|trouser|culotte|jogger|chino|short(s)?\b'),('Jackets & Coats',r'jacket|coat|blazer|parka|overshirt|shacket|chore'),('Sweaters & Knitwear',r'sweater|cardigan|jumper|knit|pullover|vest\b'),('Shirts & Blouses',r'\bshirt|blouse|button[- ]?(up|down)|tunic'),('Tops & Tees',r'\btee\b|t-shirt|\btop\b|tank|camisole|cami\b|bodysuit|henley|polo')]
EXCL=re.compile(r"\bmen'?s?\b|\bkid|\bbaby|\bgift card|\bcandle|\bmug\b|\bsock|\bshoe|\bboot|\bsandal|\bhat\b|\bcap\b|\bscarf|\bbag\b|\btote|\bbelt\b|\bjewel|\bearring|\bnecklace|\bswim|\bbikini|\bunderwear|\bbra\b|\bpanty|\bbrief|\bpillow|\bblanket|\bhome\b|\bapron|\bdog\b|\bbook\b|\bprint\b(?!ed)|\bposter|\bpin\b|\bpatch\b|\bsticker|\bmask\b|\bbeanie|\bglove|\bmitten|\bpajama|\bpyjama|\bsleep|\brobe\b|\bbeauty|\bperfume|\bsoap|\bcandle", re.I)
def fibres(text):
