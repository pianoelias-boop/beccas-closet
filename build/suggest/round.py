...
CUTS = ['wide leg', 'wide-leg', 'barrel', 'straight leg', 'tapered', 'culotte', 'a-line', 'a line', 'wrap', 'tiered', 'pleated', 'pleat', 'midi', 'maxi', 'mini', 'shirtdress', 'shirt dress', 'utility', 'cargo', 'pocket', 'elastic', 'pull-on', 'pull on', 'button', 'collar', 'sleeveless', 'long sleeve', 'short sleeve', 'cropped', 'relaxed', 'fitted', 'oversized', 'high rise', 'high-rise', 'racerback', 'scoop', 'smocked', 'belted', 'tank']
...
def write_profile_auto(saved, passed, w):
    ...
    lines += [f'- Brands she saves: {top("brand:")}', f'- Categories: {top("cat:")}', f'- Colours: {top("color:")}', f'- Fabrics: {top("fab:")}', f'- Cuts and details: {top("cut:", 10)}', f'- Price bands: {top("price:")}']
...
STOP = {'the', 'in', 'and', 'with', 'a', 'of', 'for', 'women', "women's", 'womens', 'pants', 'pant', 'trousers', 'trouser', 'skirt', 'dress', 'jumpsuit', 'top', 'tank', 'shirt', 'jacket', 'coat', 'sweater'}
...
def stage1():
    ...
    for cat in ('Dresses', 'Skirts', 'Pants', 'Jumpsuits & Rompers', 'Sweaters & Knitwear', 'Shirts & Blouses', 'Tops & Tees', 'Jackets & Coats'):
