...
LIKE=re.compile(r'shirt ?dress|shirtdress|midi|maxi|wrap|a-line|tiered|smock|pleat|puff|linen|cotton|jersey|poplin|wide[- ]leg|barrel|high[- ]rise|cardigan|merino|fair isle|stripe|floral|print|pocket', re.I)
...
QUOTA={'Dresses':16,'Jumpsuits & Rompers':8,'Skirts':8,'Pants':8,'Jeans':4,'Sweaters & Knitwear':8,'Shirts & Blouses':8,'Tops & Tees':6,'Jackets & Coats':4}
short=[]
